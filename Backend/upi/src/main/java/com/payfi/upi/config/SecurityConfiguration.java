...
public class SecurityConfiguration {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests(configurer -> configurer.antMatchers("/upi/transactionapi/**", "/upi/utilityapi")
				.permitAll().antMatchers("/upi/testwithtoken", "/api/reviews/secure/**", "/api/messages/secure/**",
						"/api/admin/secure/**")
